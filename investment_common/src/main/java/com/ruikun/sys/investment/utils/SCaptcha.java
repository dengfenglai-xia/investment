...
public class SCaptcha {  
	...
	private char[] codeSequence = { 'A', 'B', 'D', 'E', 'F', 'H',
			 'J', 'K', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U',
     ...
     *            图片高 
     */  
    public SCaptcha(int width, int height,HttpServletRequest request) {  
        this.width = width;  
        this.height = height;  
        this.createCode();  
    }  
     ...
     *            干扰线条数 
     */  
    public SCaptcha(int width, int height, int codeCount, int lineCount,HttpServletRequest request) {  
        this.width = width;  
        this.height = height;  
    ...
    public static void main(String[] args) {
		...
		System.out.println(s.createCode());;
	}
    ...
    class ImgFontByte {  
        ...
        // 字体文件的十六进制字符串  
//        private String getFontByteStr() throws IOException { 
//        	String str = "";
//        	try {
//        		str = ReadConfig.getProperty("fontByteStr");
//            } catch (Exception e) {
//                throw new IOException("未配置fontByteStr参数");
//            }  	
//            return str;  
//        }
    }  
